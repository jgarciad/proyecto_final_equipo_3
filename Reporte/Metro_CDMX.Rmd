...
La figura 5 es sólo una muestra de todos los nodos y pesos definidos, por ejemplo podemos ver que existe una conección entre el nodo "Pantitlan" y el nodo "Hangares" cuyo peso (distancia en este caso) es de 1644 metros.

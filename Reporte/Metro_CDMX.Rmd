...
+ Es masomenos un algoritmo de fuerza bruta pues tiene que visitar toda la gráfica partiendo de un nodo para conocer la distancia más corta.
+ Los pesos de las aristas tienen que ser positivos de lo contrario no funciona aunque 
